...
/* harmony import */ var _components_productsActions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/productsActions */ "./src/js/components/productsActions.js");
/* harmony import */ var _components_addReview__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/addReview */ "./src/js/components/addReview.js");
/* harmony import */ var _components_askQuestion__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/askQuestion */ "./src/js/components/askQuestion.js");
/* harmony import */ var _components_scrolling__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/scrolling */ "./src/js/components/scrolling.js");
...
(0,_components_productsActions__WEBPACK_IMPORTED_MODULE_0__["default"])();
(0,_components_addReview__WEBPACK_IMPORTED_MODULE_1__["default"])();
(0,_components_askQuestion__WEBPACK_IMPORTED_MODULE_2__["default"])();
(0,_components_scrolling__WEBPACK_IMPORTED_MODULE_3__["default"])();
...
/* harmony import */ var _functions_get_block_height__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./functions/get-block-height */ "./src/js/functions/get-block-height.js");
...
/* harmony import */ var _functions_rating__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./functions/rating */ "./src/js/functions/rating.js");
...
/* harmony import */ var _functions_isWebp__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./functions/isWebp */ "./src/js/functions/isWebp.js");
// ========================================================================================
...
(0,_functions_get_block_height__WEBPACK_IMPORTED_MODULE_2__.getHeaderHeight)();
(0,_functions_get_block_height__WEBPACK_IMPORTED_MODULE_2__.getTopInfoHeight)();
...
_functions_rating__WEBPACK_IMPORTED_MODULE_4__.formRating();
...
(0,_functions_isWebp__WEBPACK_IMPORTED_MODULE_7__["default"])();
...
/***/ "./src/js/components/addReview.js":
/*!****************************************!*\
  !*** ./src/js/components/addReview.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _functions_rating__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../functions/rating */ "./src/js/functions/rating.js");
/* harmony import */ var _gettingDate__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./gettingDate */ "./src/js/components/gettingDate.js");
...
function addReview() {
  ...
  btn.addEventListener('click', () => {
    const modalHTML = `
        ...
        `;
    (0,_modal__WEBPACK_IMPORTED_MODULE_0__["default"])(modalHTML, '.add-review', '.modal-primary', 300);
    const addReviewModal = document.querySelector('.add-review');
    if (addReviewModal) {
      (0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_3__.validateForms)(`.add-review__content`, addReviewValidateRules, false, sendEmail);
      _functions_rating__WEBPACK_IMPORTED_MODULE_1__.formRating();
    }
    function sendEmail() {
      ...
      const formData = {
        ...
        day: (0,_gettingDate__WEBPACK_IMPORTED_MODULE_2__["default"])().day,
        month: (0,_gettingDate__WEBPACK_IMPORTED_MODULE_2__["default"])().month,
        year: (0,_gettingDate__WEBPACK_IMPORTED_MODULE_2__["default"])().year,
        date: (0,_gettingDate__WEBPACK_IMPORTED_MODULE_2__["default"])().currentDate
      };
...
/***/ "./src/js/components/askQuestion.js":
/*!******************************************!*\
  !*** ./src/js/components/askQuestion.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function askQuestion() {
  if (document.querySelector('.ask-question__form')) {
    (0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)(`.ask-question--one .ask-question__form`, askQuestionValidateRules1);
    (0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)(`.ask-question--two .ask-question__form`, askQuestionValidateRules2);
  }
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (askQuestion);

/***/ }),

/***/ "./src/js/components/gettingDate.js":
/*!******************************************!*\
  !*** ./src/js/components/gettingDate.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (gettingDate);
...
const modal = function (modalHTML, container, unifyingClass) {
  let speed = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 300;
...
/***/ "./src/js/components/productsActions.js":
/*!**********************************************!*\
  !*** ./src/js/components/productsActions.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _readCompletely__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./readCompletely */ "./src/js/components/readCompletely.js");
...
const productsActions = () => {
  ...
  async function getProducts() {
    ...
    if (response.ok) {
      ...
      (0,_quantity__WEBPACK_IMPORTED_MODULE_0__["default"])('.popular-products__list', 50);
      productsMore();
      ...
      if (target.classList.contains('product-card__btn')) {
        ...
        for (let item of productsArray) {
          if (parseInt(productCard.dataset.productId) === item.id) {
            ...
            (0,_quantity__WEBPACK_IMPORTED_MODULE_0__["default"])('.product-modal', 50);
            (0,_readCompletely__WEBPACK_IMPORTED_MODULE_1__["default"])('.product-settings', '.product-settings__btn', '.product-settings__item', 8);
            deliverySelect('.product-modal__select');
            (0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_4__.validateForms)('.product-modal__content', productModalValidateRules);
            break;
          }
        }
      }
  ...
  function productModalGeneration(itemData, productCard) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_3__["default"])(modalHTML, '.product-modal', '.modal-primary', 300);
  }
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (productsActions);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
const quantity = function (containerEl) {
  let maxValue = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 10;
...
/***/ "./src/js/components/readCompletely.js":
/*!*********************************************!*\
  !*** ./src/js/components/readCompletely.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
const readCompletely = function (container, button, item) {
  let visibleItem = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 5;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (readCompletely);
...
/***/ "./src/js/functions/get-block-height.js":
/*!**********************************************!*\
  !*** ./src/js/functions/get-block-height.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "getTopInfoHeight": () => (/* binding */ getTopInfoHeight)
/* harmony export */ });
const getHeaderHeight = () => {
  const headerHeight = document?.querySelector('.header').offsetHeight;
  document.querySelector(':root').style.setProperty('--header-height', `${headerHeight}px`);
};
const getTopInfoHeight = () => {
...
function initSliders() {
  if (document.querySelector('.reviews__list')) {
    new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.reviews__list', {
      // effect: 'fade',
      // autoplay: {
      // 	delay: 3000,
...
const validateForms = function (selector, rules, afterSend) {
  let sendEmail = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
